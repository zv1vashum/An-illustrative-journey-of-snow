...
<h3><b>Bringing and immersive learning experience in natural sciences for non-experts</b></h3><br>
...
<p>Textbooks and museums are filled with enormous amounts of information.
...
documentary makers and photographers.<br>
...
will demonstrate the interactive storytelling for my final presentation.</p>

<h1 id="intro">1.0 Introduction: An illustrative journey of snow</h1>
<p>Snowflake begins its journey from among the clouds as an ice crystal. The temperature
...
snowflakes are an intriguing experience to witness.<br>
...
manipulate a part of the growing process.<br>
...
target groups into consideration.<br>
...
of information. <i>(History Of Drawing timeline., 2020)</i><br>
...
through visual and interactive experience.<br>
...
clearer for them to understand.<br>
...
ones without being critical of our previously held ideas and knowledge.</p>

<h1 id="aim">2.0 Aim: Creating an immersive experience</h1>
<p>•Creating an artifact for interactive storytelling of snow crystals.
...
users with or without disabilities can participate.<br>
•Synthesizing the morphology of snow structures with code and making it
tangible enough for user interaction.<br>
...
designer helping the experts in the field.<br>
...
to bring this story to both digital and analog interaction.<br>
...
<p>Snowflakes have been extensively researched to understand its hexagonal
...
better experience for these target groups.<br>
...
in inclusive concepts in these spaces.<br>
...
in any educational spaces or museums.<br>
...
learning, especially for the non-experts.</p>


<h1 id="conception">4.0 Conception: A human and object experience</h1>
<p>The illustrative journey of snowflakes design is based on observation as well as
...
<p>The word syntonic means harmony, same frequency and attuned especially with
...
explored places.</p><br>
<p>This quote by Seymour Papert who termed syntonic learning beautifully explains
what it means.<br>
...
course it could happen.<br>
We used to watch the stars that fell, too and see them streak down. Jim allowed
they’d got spoiled and was hove out of the nest.”</i> (Yoshiki Okoshima, 2016)<br>
...
understanding of what syntonic learning can teach.</p>

<h1 id="visScience">4.2 Visual Science: Study of snow crystals into diagrams</h1>
<p>I have looked for scientific visualization of many stages of growing snow crystals
...
<p>I have analysed the importance of demonstration, to explain in visuals the
...
and simple words with important terms to communicate to the viewers.<br>
...
<p>My design focuses on building a story for the visually impaired and to make
...
for my tactile graphics are:<br>
...
confused with each other if the cat didn’t have whiskers and its pointy ears.</p>
<figure>
...
<p>I implemented the design thinking method and focused on the user’s immersive
...
learning, and bringing inclusivity into my design.<br>
...
The design thinking process was carried out into the following list:<br>
1. A workshop where I observe participants’ visual interpretations of their
experiences of snow.<br>
...
elements in nature, mainly humidity and temperature.<br>
...
<p>To make the growing symmetrical design of snowflakes, I started exploring
...
Each shape like Stel6, den26, and branch have repetitive code in it too.<br>
<i>
to StellarP <br>
pu fd 100 pd molecule wait 15 cngon 6 20 120 wait 15 Stel6 wait 15 Stel26 wait<br>
10 stel36<br>
wait 15 stel46 wait 15 veins wait 15 dend16 wait 15 dend26 wait 15 dend36<br>
wait 15 branch<br>
wait 15 tip16 wait 5 tip2 wait 5 tip36 wait 5 repeat 6 [ longhex rt 60] end <br>
</i>
<br>
...
<p>I built an interactive artifact that synchronizes with the story of the creation of
...
formed. The brainstorming to sketching this idea took place with a lot of whatifs:<br>
<ol>
...
<br>
The prototype started with the following questions:<br>
•What will I talk to my users about?<br>
•How can I re-create snowflakes and tell its story of creation?<br>
The question consists of the following exploration<br>
...
<p>I built a quick prototype for the installation with paper and graphics with a 3D
...
to an approx. two and a half feet tall structure.</p>

<h1 id="sketchTactile">5.2. Storytelling:Story sketched for tactile graphics</h1>
<p>I illustrated how and where the snow starts for my tactile graphics.
...
<p>The installation has three sides. Each face shows the visual transition of the
story. The visual story is shown as light animation on each tactile graphics and
has text engraved on the base for the users to read the content.<br>
...
<p>The tactile graphics and LED lights for the installation required a good amount of
space between them to help evenly spread the lights it would emit. The cut-out
stands for each graphics were built to resolve the much-needed space for the
lights to glow evenly.</p>
<figure>
...
<p>The tactile graphics come to life and are animated with the help LEDs
...
<p>My project concept is to build an engaging environment where users and the
...
List of findings from my workshop:</p>
<ol>
...
<p>In the other part of my design concept, I focused on creating digital interaction
...
List of fi ndings in visual programming:</p>
<ol>
...
<p>The idea for this installation is to avoid overwhelming information. Otherwise, it
...
They add a much needed artistic appeal for the users.<br>
...
space and problem-solving task that piqued curiosity in users.<br>
...
<p>This project’s interactive installation was built using an interdisciplinary
...
designers with similar project ideas.<br>
...
hand experience of what can be made better in a learning environment.<br>
...
by exploring the possibilities with morphing snowflakes.</p>

<h1 id="outlook">9.0 Outlook: Experimental learning design</h1>
<p><b>Exploring graphic design and storytelling in the field of natural sciences
and museums.</b><br>
...
spaces and centers of experiential learning.<br>
...
learning space for non-experts.</p>


<h1 id="reference">10.0 Reference</h1>
<ol>
<li>Yoshiki, Ohshima. (2016, August 4). VPRI-0857 Seymour Papert
on Logo: Teaching [Video]. Retrieved from <a href="https://www.youtube.com/
watch?v=ZG9cYhekB8A "></a></li>
...
Maruša Bradač [Video]. Retrieved from <a href="https://youtu.be/FwGH4gulLX4"></a>
1. Because Science (2020, May 12). Figure 18. Can two snowflakes be
identical? - [Video]. Retrieved from <a href="https://www.instagram.com/tv/
CAF5EfuH0-4/?utm_source=ig_web_copy_link"></a></li>
